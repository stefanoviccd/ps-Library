...
public class TableModelBook extends AbstractTableModel {
    ...
    private String[] columnNames=new String[]{"ID", "Naziv", "Autor", "Godina izdanja", "Kategorija", "Na stanju"};
    ...
    public Object getValueAt(int rowIndex, int columnIndex) {
        ...
        switch(columnIndex){
            case 0: return k.getBookid();
            case 1: return k.getBookName();
            case 2: return k.getAuthor();
            case 3: return k.getIssueDate();
            case 4: return k.getBookCategory();
            case 5: return k.getNumberInStock();
        }
        return "n/a";
